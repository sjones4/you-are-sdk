 ...
 *
 */
public class ListAccountPoliciesResultStaxUnmarshaller implements Unmarshaller<ListAccountPoliciesResult, StaxUnmarshallerContext> {
  ...
  public ListAccountPoliciesResult unmarshall(StaxUnmarshallerContext context) throws Exception {
    ...
    while (true) {
      ...
      if (xmlEvent.isEndDocument()) return listAccountPoliciesResult;

      if (xmlEvent.isAttribute() || xmlEvent.isStartElement()) {
        if (context.testExpression("PolicyNames/member", targetDepth)) {
          listAccountPoliciesResult.getPolicyNames().add( SimpleTypeStaxUnmarshallers.StringStaxUnmarshaller.getInstance().unmarshall( context ) );
          continue;
        }
  ...
  private static ListAccountPoliciesResultStaxUnmarshaller instance = new ListAccountPoliciesResultStaxUnmarshaller();
