...
public class GetAccountPolicyRequest extends AmazonWebServiceRequest implements Serializable {
  ...
  public GetAccountPolicyRequest() {}

  public GetAccountPolicyRequest(String accountName, String policyName) {
  ...
  public GetAccountPolicyRequest withAccountName(String accountName) {
    setAccountName( accountName );
    return this;
  }
  ...
  public GetAccountPolicyRequest withPolicyName(String policyName) {
    setPolicyName( policyName );
    return this;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (obj instanceof GetAccountPolicyRequest == false) return false;
    GetAccountPolicyRequest other = (GetAccountPolicyRequest)obj;
