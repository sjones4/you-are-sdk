 ...
 *
 */
public class GetAccountPolicyRequestMarshaller implements Marshaller<Request<GetAccountPolicyRequest>, GetAccountPolicyRequest> {
  ...
  public Request<GetAccountPolicyRequest> marshall(GetAccountPolicyRequest getAccountPolicyRequest) {
    ...
    Request<GetAccountPolicyRequest> request = new DefaultRequest<>(getAccountPolicyRequest, "AmazonIdentityManagement");
