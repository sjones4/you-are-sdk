 ...
 *
 */
public class ListAccountsRequestMarshaller implements Marshaller<Request<ListAccountsRequest>, ListAccountsRequest> {
  ...
  public Request<ListAccountsRequest> marshall(ListAccountsRequest listAccountsRequest) {
    ...
    Request<ListAccountsRequest> request = new DefaultRequest<>(listAccountsRequest, "AmazonIdentityManagement");
