 ...
 *
 */
public class GetAccessTokenRequestMarshaller implements Marshaller<Request<GetAccessTokenRequest>, GetAccessTokenRequest> {
  ...
  public Request<GetAccessTokenRequest> marshall(GetAccessTokenRequest getAccessTokenRequest) {
    ...
    Request<GetAccessTokenRequest> request = new DefaultRequest<GetAccessTokenRequest>(getAccessTokenRequest, "AWSSecurityTokenService");
    request.addParameter("Action", "GetAccessToken");
    request.addParameter("Version", "2011-06-15");

    if (getAccessTokenRequest.getDurationSeconds() != null) {
      request.addParameter("DurationSeconds", StringUtils.fromInteger( getAccessTokenRequest.getDurationSeconds() ));
    }
