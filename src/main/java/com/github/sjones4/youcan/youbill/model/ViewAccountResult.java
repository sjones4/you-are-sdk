 ...
 *
 */
public class ViewAccountResult implements Serializable {
  ...
  public boolean equals( Object obj ) {
    ...
    if ( obj instanceof ViewAccountResult == false ) return false;
    ViewAccountResult other = (ViewAccountResult) obj;
