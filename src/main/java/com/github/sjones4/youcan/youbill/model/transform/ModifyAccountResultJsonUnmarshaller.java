...
public class ModifyAccountResultJsonUnmarshaller implements Unmarshaller<ModifyAccountResult, JsonUnmarshallerContext> {
      ...
      while ( true ) {
        ...
        if (token == JsonToken.FIELD_NAME || token == JsonToken.START_OBJECT) {
          if (context.testExpression("accountSettings", targetDepth)) {
            context.nextToken();
            modifyAccountResult.setAccountSettings(AccountSettingsJsonUnmarshaller.getInstance().unmarshall(context));
          }
  ...
  private static ModifyAccountResultJsonUnmarshaller instance = new ModifyAccountResultJsonUnmarshaller( );
