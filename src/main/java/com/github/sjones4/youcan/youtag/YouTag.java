 ...
 *
 */
public interface YouTag {

  GetTagKeysResult getTagKeys( ) throws AmazonClientException;

  GetTagKeysResult getTagKeys( final GetTagKeysRequest getTagKeysRequest ) throws AmazonClientException;
}
